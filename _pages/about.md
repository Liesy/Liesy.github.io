...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">ACL 2026</div><img src='images/race.png' alt="sym" width="100%"></div></div>
...
- **Focus:** We study a rigorous four-class fine-grained detection setting that explicitly distinguishes **LLM-Polished Human Text** and **Humanized LLM Text**.
...
- `ACL 2026` Logic as a Bridge: Improving LLM Hallucination Detection via Label Constraint Modeling between Responses and Self-Judgments
